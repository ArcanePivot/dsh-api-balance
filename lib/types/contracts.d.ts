export declare const API_BASE_PATH = "/api/api-balance";
export declare const BALANCE_PATH = "/api/api-balance/balance";
export declare const USAGE_PATH = "/api/api-balance/usage";
